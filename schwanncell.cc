...
#include "schwanncell.h"

bool SchwannCell::ResetParameters(std::chrono::time_point<Clock> event_time)
{
...
int SchwannCell::Update(std::chrono::time_point<Clock> event_time)
{
