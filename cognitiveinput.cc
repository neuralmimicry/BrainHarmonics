...
bool CognitiveInput::ResetParameters(std::chrono::time_point<Clock> event_time)
{
    ...
    if(cognitiveinput_type < 1)
        {
        cognitiveinput_type = 1;
        }
...
int CognitiveInput::Update(std::chrono::time_point<Clock> event_time)
{
