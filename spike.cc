/*------------------------------------------------------------------------------*/
/* @file      spike.cc                                                          */
/* @details   Single dimension spike operations. Can be combined for multidimension */
/* @author    Paul Isaac's                                                      */
/* @date      16.02.2016                                                        */
...
bool Spike::ResetParameters(std::chrono::time_point<Clock> event_time)
{
...
int Spike::Update(std::chrono::time_point<Clock> event_time)
{
