...
#include "myelinsheath.h"
#include "axonbranch.h"

bool MyelinSheath::ResetParameters(std::chrono::time_point<Clock> event_time)
{
...
int MyelinSheath::Update(std::chrono::time_point<Clock> event_time)
{
