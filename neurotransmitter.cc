...
bool Neurotransmitter::ResetParameters(std::chrono::time_point<Clock> event_time)
{
    ...
    if(neurotransmitter_type < 1)
        {
        neurotransmitter_type = 1;
        }
...
int Neurotransmitter::Update(std::chrono::time_point<Clock> event_time)
{
